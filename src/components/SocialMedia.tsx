...
export const socialMediaProfiles = [
  { title: 'Facebook', href: 'https://www.facebook.com/profile.php?id=61568344311792', icon: FacebookIcon },
  { title: 'Instagram', href: 'https://www.instagram.com/summitdevlabs/?hl=en', icon: InstagramIcon },
  { title: 'GitHub', href: 'https://github.com/Summit-DevLabs', icon: GitHubIcon },
]
